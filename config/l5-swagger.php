...
return [
    ...
    'defaults' => [
         ...
         * 'method' (sort by HTTP method) or null (the default is unsorted - default).
         */
        ...
        'ui' => [
            'display' => [
                ...
                /**
                 * If set to true, it persists the 'Try it out' and other expanded areas
                 */
                'persist_expansion' => env('L5_SWAGGER_UI_PERSIST_EXPANSION', false),
            ],
         ...
         */
        'constants' => [
            'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'https://apixies.io'),
        ],
    ],
];
