<div class="tab-content hidden p-6" id="examples">
    ...
    <div class="mb-6">
        <h3 class="font-medium text-gray-800 mb-3">Email Inspector (cURL)</h3>
  ...
  -H 'Authorization: Bearer YOUR_API_KEY'</code></pre>
    ...
    <div class="mb-6">
        <h3 class="font-medium text-gray-800 mb-3">Email Inspector (JavaScript)</h3>
        <pre class="code-block"><code>// JavaScript fetch example
fetch(`https://{{ request()->getHost() }}/api/v1/inspect-email?email=someone@example.com`, {
  headers: {
...
.catch(error => console.error('Error:', error));</code></pre>
    ...
    <div>
        <h3 class="font-medium text-gray-800 mb-3">Email Inspector (PHP cURL)</h3>
