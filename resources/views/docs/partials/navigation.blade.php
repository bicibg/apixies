        ...
        <div class="nav-section rounded-lg overflow-hidden shadow-sm bg-white">
            ...
            <div class="p-3 md:p-4">
                <ul class="space-y-1 md:space-y-2">
                    ...
                    <li>
                        <a href="{{ url('api/documentation') }}" target="_blank" @click="endpointsOpen = false"
                           class="block px-3 py-2 rounded transition-colors {{ $activeSection === 'openapi' ? 'bg-navy text-white font-medium' : 'text-gray-700 hover:bg-blue-50' }} flex items-center">
                            OpenAPI Docs
