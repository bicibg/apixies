...
<header class="bg-gradient-to-r from-[#0A2240] to-[#007C91] py-3">
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4">
        ...
        <div class="flex flex-wrap justify-center md:justify-end items-center space-x-3 md:space-x-5">
            <a href="{{ route('getApiRoutes') }}" class="text-white hover:text-gray-200 text-sm py-1">API Docs</a>
...
<div id="mobile-menu" class="hidden md:hidden bg-white shadow-md">
    <div class="container mx-auto px-4 py-2 space-y-2">
        <a href="{{ route('getApiRoutes') }}" class="block py-2 px-3 text-gray-800 hover:bg-gray-100 rounded">API Docs</a>
